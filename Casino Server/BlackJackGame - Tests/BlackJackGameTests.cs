...
namespace CasinoLibraryTests
{
    ...
    public class BlackjackGameTests
    {
        ...
        public void Initialize()
        {
            ...
            game = new BlackjackGame(fakeServer);
        }
        ...
        public void GameOutcome_PlayerWin()
        {
            ...
            // Act
            string result = game.gameOutcome(game.playerHand, "p");

            // Assert
            Assert.AreEqual("******Winner: Player******", result);
        }
        ...
        public void GameOutcome_DealerWin()
        {
            ...
            // Assert
            Assert.AreEqual("******Dealer wins.******", result);
        }
        ...
        public void GameOutcome_DealerBust()
        {
            ...
            Assert.AreEqual("******Dealer busted! Winner: Player******", result);
        }
        ...
        public void RunGame_ExecutesAllGamePhases()
        {
            ...
            Assert.AreEqual("3", lastCard.Rank, "The last card in player's hand should be the card dealt ('3' of Diamonds).");
        ...
        public void playerDecision_PlayerHits()
        {
            ...
            var lastCard = game.playerHand.Last();
            Assert.AreEqual("5", lastCard.Rank, "The last card should be a 5 of Diamonds.");
        }
        ...
        public void Listen_WaitsForSpecificPacket()
        {
            ...
            // Act
            game.Listen(); // Should exit loop when PacketType 2 is received
        ...
        public void runBJP_HandlesCardRequestForPlayer()
        {
            ...
            // Act
            game.runBJP(); // This would be triggered internally after a packet is received

            // Assert
            var expected = "Ace,Hearts"; // Assuming this is the format for your packet data
        ...
        public void runBJP_HandlesCardRequestForDealer()
        {
            ...
            // Act
            game.runBJP(); // Trigger the method processing the packet

            // Assert
            var expected = "Ace,Diamonds";
        ...
        public void runBJP_HandlesHandTotalRequestForPlayer()
        {
            ...
            // Act
            game.runBJP(); // Process the hand total request
        ...
        public void runBJP_HandlesHandTotalRequestForDealerShowingSecondCardOnly()
        {
            ...
            // Act
            game.runBJP(); // Process the hand total request, second card only for dealer
        ...
        public void runBJP_HandlesCardCountRequestForPlayer()
        {
            ...
            // Act
            game.runBJP(); // Process the card count request
